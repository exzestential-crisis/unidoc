  ...
  return (
    <div className="relative">
      ...
      {canScrollLeft && (
        <button
          onClick={scrollLeft}
          className="absolute left-0 top-1/2 h-60 w-20 -translate-y-1/2 z-10 bg-gradient-to-l from-0% to-zinc-100"
        >
          <span className="text-xl font-bold text-gray-600 dark:text-gray-300 pr-10">
            &lt;
          </span>
        </button>
      )}
      ...
      {canScrollRight && (
        <button
          onClick={scrollRight}
          className="absolute right-0 top-1/2 h-60 w-20 -translate-y-1/2 z-10 bg-gradient-to-r from-0% to-zinc-100"
        >
